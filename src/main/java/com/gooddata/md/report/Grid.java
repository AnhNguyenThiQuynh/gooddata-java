...
public class Grid {
     ...
     */
    @JsonCreator
    public Grid(@JsonProperty("columns") @JsonDeserialize(contentUsing = GridElement.Deserializer.class)
                        List<? extends GridElement> columns,
                @JsonProperty("rows")  @JsonDeserialize(contentUsing = GridElement.Deserializer.class)
